...
namespace MyFirstMvc.Models.Infra
{
	public class EmailHelper
	{
		private string sendermail = "g01.webapp@gmail.com";
		public void SenForgetPasswordEmail(string url, string name, string email)
		{
			var subject = "[重設密碼通知]";
			var body = $@"Hi {name}
</ br>
請點此連結[<a href='{url}' target='_blank'>我要重設密碼</a>], 以進行重設密碼,如果您沒有提供申請, 請忽略本信,謝謝
</ br>";
...
請點此連結[<a href='{url}' target='_blank'>的確是我的申請會員</a>],如果您沒有提供申請, 請忽略本信,謝謝
</ br>";
			var from = sendermail;
			var to = email;
			SendViaGoogle(from, to, subject, body);
